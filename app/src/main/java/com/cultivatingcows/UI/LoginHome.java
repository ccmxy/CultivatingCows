...
public class LoginHome extends AppCompatActivity
    ...
    private static final String TAG = LoginHome.class.getSimpleName();
        ...
        mGoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mSignupButton.isActivated()) {
                    ...
                    newUser.register(TAG, LoginHome.this, new Runnable() {
                        @Override
                        public void run() {
                ...
                //Log in was pressed:
                    ...
                    if (username.isEmpty() || password.isEmpty()) {
                        ErrorHelper.displayAlertDialog(LoginHome.this, getString(R.string
                                .login_error_message));
                    } else {
                        // Login
                        User.logIn(username, password, TAG, LoginHome.this, new Runnable() {
                            @Override
                            public void run() {
                                Intent intent = new Intent(LoginHome.this, MainActivity.class);
                                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
